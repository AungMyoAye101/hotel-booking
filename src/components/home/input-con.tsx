...
const InputCon = () => {
    return (
        <div className="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-5 gap-2  items-center  p-2 bg-white rounded-lg   overflow-hidden ">
            ...
            <Input type="text" placeholder="destination" size="sm" radius="none" aria-label="destination" />
            <DatePicker size="sm" radius="none" aria-label="check in" />
            <DatePicker size="sm" radius="none" aria-label="check out" />
            <Input type="number" placeholder="guest" size="sm" radius="none" aria-label="guest" />
